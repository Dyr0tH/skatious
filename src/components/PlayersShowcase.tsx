...
export default function PlayersShowcase() {
  return (
    <div className="max-w-5xl mx-auto py-16 w-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 mb-16 mx-8">
        {teams.map((team) => (
          <div key={team.name} className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
            ...
            />
            <h2 className="font-heading text-xl font-bold text-navy-900 mb-2 text-center">{team.name}</h2>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-8 mx-8">
        {players.map((player) => (
          <div key={player.name} className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
            ...
            />
            <h3 className="font-heading text-lg font-bold text-navy-900 mb-1 text-center">{player.name}</h3>
            <p className="font-body text-gray-600 text-center">{player.team}</p>
          </div>
        ))}
      </div>
    </div>
